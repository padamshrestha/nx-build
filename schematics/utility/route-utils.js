...
function insertImport(source, fileToEdit, symbolName, fileName, isDefault) {
    ...
    if (relevantImports.length > 0) {
        ...
        if (importTextNodes.length === 0) {
            var fallbackPos_1 = ast_utils_1.findNodes(relevantImports[0], ts.SyntaxKind.CloseBraceToken)[0].pos ||
    ...
    var useStrict = ast_utils_1.findNodes(rootNode, ts.SyntaxKind.StringLiteral)
